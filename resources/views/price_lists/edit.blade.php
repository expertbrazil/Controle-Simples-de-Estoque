        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Editar Lista de Preços</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" 
                                    ...
                                    <option value="distributor" {{ old('type', $priceList->type) === 'distributor' ? 'selected' : '' }}>Distribuidor</option>
                                    <option value="consumer" {{ old('type', $priceList->type) === 'consumer' ? 'selected' : '' }}>Consumidor</option>
                                </select>
                                @error('type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" 
                                           ...
                                           value="{{ old('markup_percentage', number_format($priceList->markup_percentage, 2, ',', '.')) }}" 
                                           required>
